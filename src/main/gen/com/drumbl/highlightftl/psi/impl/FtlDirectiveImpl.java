...
public class FtlDirectiveImpl extends ASTWrapperPsiElement implements FtlDirective {

  public FtlDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FtlDirectiveBody getDirectiveBody() {
    return findChildByClass(FtlDirectiveBody.class);
  }

  @Override
  @NotNull
  public FtlDirectiveName getDirectiveName() {
